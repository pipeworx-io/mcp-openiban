...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/validate_iban \
  -H 'Content-Type: application/json' \
  -d '{"iban":"DE89 3704 0044 0532 0130 00"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/validate_iban`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
